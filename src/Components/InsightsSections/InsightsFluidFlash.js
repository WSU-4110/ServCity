  ...
  <Slider {...settings}>
    ...
    <div style={contentStyle}>
      <section>
        ...
        <p>
          Reason to change: Power steering fluid is used to steer wheel and
          guide vehicle
        </p>
      </section>
    </div>
    ...
    <div style={contentStyle}>
      <section>
        ...
        <p>When to change: Every 75,000-100,000 miles</p>
        ...
        <p>
          Reason to change: Transmission fluid keeps mechanical components cool
          and lubricated
        </p>
      </section>
    </div>

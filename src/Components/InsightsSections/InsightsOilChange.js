  ...
  <Slider {...settings}>
    ...
    <div style={contentStyle}>
      <section>
        ...
        <ul>
          <li>
            <strong>Fully Synthetic Oil:</strong> Needs replacing every: 7,500
            miles and 15,000
          </li>
          <li>
            <strong>Semi Synthetic Oil:</strong> Needs replacing every: 6,000
            miles
          </li>
          <li>
            <strong>Conventional Mineral Oil:</strong> Needs replacing every:
            3,000 miles
          </li>
        </ul>
      </section>
    ...
    <div style={contentStyle}>
      <section>
        ...
        <li>
          {" "}
          Oil level is outside the indicated range inscripted on the dipstick{" "}
        </li>
        <li> When wiping the oil, it has a black/burnt color </li>
        <li>
          {" "}
          If the oil smells slightly burnt or carries a light gasoline odor{" "}
        </li>
      </section>
    </div>
  </Slider>
